...
if(isset($_GET["action"])){
    if($_GET["action"] == "delete"){
        $recipeId = $_GET["id"];
        $query = "SELECT img FROM recipe WHERE recipeId = '$recipeId'";
        $result = mysqli_query($connect,$query);
        $row = mysqli_fetch_array($result);
        $recipeimg = $row["img"];
                    ...
                    <div class="col-md-10">
                        <div class="viewrecipe">
                            ...
                            <div class="personal-recipe">
                                ...
                                <p><a class="recipename" href="recipeinfo.php?recipe=<?php echo $row["recipeId"]?>"><?php echo $row["recipeName"];?></a></p>
